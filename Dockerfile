...
RUN apt install --yes --allow-downgrades --install-recommends wine-staging-i386=5.9~focal && apt install --yes --allow-downgrades --install-recommends wine-staging-amd64=5.9~focal && apt install --yes --allow-downgrades --install-recommends wine-staging=5.9~focal && apt install --yes --allow-downgrades --install-recommends winehq-staging=5.9~focal && runuser -l space_engineers -c "cd && env WINEARCH=win64 WINEPREFIX=/home/space_engineers/server winetricks --force -q dotnet48"
